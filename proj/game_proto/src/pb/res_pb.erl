...
%% message types
-type res_list_bag_c2s() :: #res_list_bag_c2s{}.
...
encode_msg_res_list_bag_c2s(_Msg, _TrUserData) -> <<>>.

encode_msg_res_list_bag_s2c(Msg, TrUserData) -> encode_msg_res_list_bag_s2c(Msg, <<>>, TrUserData).


encode_msg_res_list_bag_s2c(#res_list_bag_s2c{bagItem_list = F1}, Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true -> e_field_res_list_bag_s2c_bagItem_list(TrF1, Bin, TrUserData)
      end
    end.
...
encode_msg_res_list_wallet_c2s(_Msg, _TrUserData) -> <<>>.

encode_msg_res_list_wallet_s2c(Msg, TrUserData) -> encode_msg_res_list_wallet_s2c(Msg, <<>>, TrUserData).


encode_msg_res_list_wallet_s2c(#res_list_wallet_s2c{walletItem_list = F1}, Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true -> e_field_res_list_wallet_s2c_walletItem_list(TrF1, Bin, TrUserData)
      end
    end.
...
e_field_res_list_wallet_s2c_walletItem_list([], Bin, _TrUserData) -> Bin.
...
decode_msg_res_list_bag_c2s(Bin, TrUserData) -> dfp_read_field_def_res_list_bag_c2s(Bin, 0, 0, 0, TrUserData).

dfp_read_field_def_res_list_bag_c2s(<<>>, 0, 0, _, _) -> #res_list_bag_c2s{};
dfp_read_field_def_res_list_bag_c2s(Other, Z1, Z2, F, TrUserData) -> dg_read_field_def_res_list_bag_c2s(Other, Z1, Z2, F, TrUserData).

dg_read_field_def_res_list_bag_c2s(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 32 - 7 -> dg_read_field_def_res_list_bag_c2s(Rest, N + 7, X bsl N + Acc, F, TrUserData);
dg_read_field_def_res_list_bag_c2s(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_res_list_bag_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      1 -> skip_64_res_list_bag_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      2 -> skip_length_delimited_res_list_bag_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      3 -> skip_group_res_list_bag_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      5 -> skip_32_res_list_bag_c2s(Rest, 0, 0, Key bsr 3, TrUserData)
    end;
dg_read_field_def_res_list_bag_c2s(<<>>, 0, 0, _, _) -> #res_list_bag_c2s{}.

skip_varint_res_list_bag_c2s(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> skip_varint_res_list_bag_c2s(Rest, Z1, Z2, F, TrUserData);
skip_varint_res_list_bag_c2s(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_bag_c2s(Rest, Z1, Z2, F, TrUserData).

skip_length_delimited_res_list_bag_c2s(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 57 -> skip_length_delimited_res_list_bag_c2s(Rest, N + 7, X bsl N + Acc, F, TrUserData);
skip_length_delimited_res_list_bag_c2s(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_res_list_bag_c2s(Rest2, 0, 0, F, TrUserData).

skip_group_res_list_bag_c2s(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_res_list_bag_c2s(Rest, 0, Z2, FNum, TrUserData).

skip_32_res_list_bag_c2s(<<_:32, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_bag_c2s(Rest, Z1, Z2, F, TrUserData).

skip_64_res_list_bag_c2s(<<_:64, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_bag_c2s(Rest, Z1, Z2, F, TrUserData).

decode_msg_res_list_bag_s2c(Bin, TrUserData) -> dfp_read_field_def_res_list_bag_s2c(Bin, 0, 0, 0, id([], TrUserData), TrUserData).

dfp_read_field_def_res_list_bag_s2c(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_res_list_bag_s2c_bagItem_list(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_res_list_bag_s2c(<<>>, 0, 0, _, R1, TrUserData) -> #res_list_bag_s2c{bagItem_list = lists_reverse(R1, TrUserData)};
dfp_read_field_def_res_list_bag_s2c(Other, Z1, Z2, F, F@_1, TrUserData) -> dg_read_field_def_res_list_bag_s2c(Other, Z1, Z2, F, F@_1, TrUserData).

dg_read_field_def_res_list_bag_s2c(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_res_list_bag_s2c(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
dg_read_field_def_res_list_bag_s2c(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 -> d_field_res_list_bag_s2c_bagItem_list(Rest, 0, 0, 0, F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_res_list_bag_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    1 -> skip_64_res_list_bag_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    2 -> skip_length_delimited_res_list_bag_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    3 -> skip_group_res_list_bag_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    5 -> skip_32_res_list_bag_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_res_list_bag_s2c(<<>>, 0, 0, _, R1, TrUserData) -> #res_list_bag_s2c{bagItem_list = lists_reverse(R1, TrUserData)}.
...
skip_varint_res_list_bag_s2c(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_res_list_bag_s2c(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_length_delimited_res_list_bag_s2c(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> skip_length_delimited_res_list_bag_s2c(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
skip_length_delimited_res_list_bag_s2c(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_res_list_bag_s2c(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_res_list_bag_s2c(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_res_list_bag_s2c(Rest, 0, Z2, FNum, F@_1, TrUserData).

skip_32_res_list_bag_s2c(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_res_list_bag_s2c(Rest, Z1, Z2, F, F@_1, TrUserData).
...
dfp_read_field_def_res_list_wallet_c2s(<<>>, 0, 0, _, _) -> #res_list_wallet_c2s{};
dfp_read_field_def_res_list_wallet_c2s(Other, Z1, Z2, F, TrUserData) -> dg_read_field_def_res_list_wallet_c2s(Other, Z1, Z2, F, TrUserData).

dg_read_field_def_res_list_wallet_c2s(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 32 - 7 -> dg_read_field_def_res_list_wallet_c2s(Rest, N + 7, X bsl N + Acc, F, TrUserData);
dg_read_field_def_res_list_wallet_c2s(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_res_list_wallet_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      1 -> skip_64_res_list_wallet_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      2 -> skip_length_delimited_res_list_wallet_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      3 -> skip_group_res_list_wallet_c2s(Rest, 0, 0, Key bsr 3, TrUserData);
      5 -> skip_32_res_list_wallet_c2s(Rest, 0, 0, Key bsr 3, TrUserData)
    end;
dg_read_field_def_res_list_wallet_c2s(<<>>, 0, 0, _, _) -> #res_list_wallet_c2s{}.

skip_varint_res_list_wallet_c2s(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> skip_varint_res_list_wallet_c2s(Rest, Z1, Z2, F, TrUserData);
skip_varint_res_list_wallet_c2s(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_wallet_c2s(Rest, Z1, Z2, F, TrUserData).

skip_length_delimited_res_list_wallet_c2s(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 57 -> skip_length_delimited_res_list_wallet_c2s(Rest, N + 7, X bsl N + Acc, F, TrUserData);
skip_length_delimited_res_list_wallet_c2s(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_res_list_wallet_c2s(Rest2, 0, 0, F, TrUserData).

skip_group_res_list_wallet_c2s(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_res_list_wallet_c2s(Rest, 0, Z2, FNum, TrUserData).

skip_32_res_list_wallet_c2s(<<_:32, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_wallet_c2s(Rest, Z1, Z2, F, TrUserData).

skip_64_res_list_wallet_c2s(<<_:64, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_res_list_wallet_c2s(Rest, Z1, Z2, F, TrUserData).

decode_msg_res_list_wallet_s2c(Bin, TrUserData) -> dfp_read_field_def_res_list_wallet_s2c(Bin, 0, 0, 0, id([], TrUserData), TrUserData).

dfp_read_field_def_res_list_wallet_s2c(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_res_list_wallet_s2c_walletItem_list(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_res_list_wallet_s2c(<<>>, 0, 0, _, R1, TrUserData) -> #res_list_wallet_s2c{walletItem_list = lists_reverse(R1, TrUserData)};
dfp_read_field_def_res_list_wallet_s2c(Other, Z1, Z2, F, F@_1, TrUserData) -> dg_read_field_def_res_list_wallet_s2c(Other, Z1, Z2, F, F@_1, TrUserData).

dg_read_field_def_res_list_wallet_s2c(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_res_list_wallet_s2c(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
dg_read_field_def_res_list_wallet_s2c(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 -> d_field_res_list_wallet_s2c_walletItem_list(Rest, 0, 0, 0, F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_res_list_wallet_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    1 -> skip_64_res_list_wallet_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    2 -> skip_length_delimited_res_list_wallet_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    3 -> skip_group_res_list_wallet_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
	    5 -> skip_32_res_list_wallet_s2c(Rest, 0, 0, Key bsr 3, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_res_list_wallet_s2c(<<>>, 0, 0, _, R1, TrUserData) -> #res_list_wallet_s2c{walletItem_list = lists_reverse(R1, TrUserData)}.
...
skip_varint_res_list_wallet_s2c(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_res_list_wallet_s2c(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_length_delimited_res_list_wallet_s2c(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> skip_length_delimited_res_list_wallet_s2c(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
skip_length_delimited_res_list_wallet_s2c(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_res_list_wallet_s2c(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_res_list_wallet_s2c(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_res_list_wallet_s2c(Rest, 0, Z2, FNum, F@_1, TrUserData).

skip_32_res_list_wallet_s2c(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_res_list_wallet_s2c(Rest, Z1, Z2, F, F@_1, TrUserData).
...
merge_msg_res_list_bag_c2s(_Prev, New, _TrUserData) -> New.

-compile({nowarn_unused_function,merge_msg_res_list_bag_s2c/3}).
merge_msg_res_list_bag_s2c(#res_list_bag_s2c{bagItem_list = PFbagItem_list}, #res_list_bag_s2c{bagItem_list = NFbagItem_list}, TrUserData) ->
    #res_list_bag_s2c{bagItem_list =
			  if PFbagItem_list /= undefined, NFbagItem_list /= undefined -> 'erlang_++'(PFbagItem_list, NFbagItem_list, TrUserData);
			     PFbagItem_list == undefined -> NFbagItem_list;
...
-compile({nowarn_unused_function,merge_msg_res_list_wallet_s2c/3}).
merge_msg_res_list_wallet_s2c(#res_list_wallet_s2c{walletItem_list = PFwalletItem_list}, #res_list_wallet_s2c{walletItem_list = NFwalletItem_list}, TrUserData) ->
    #res_list_wallet_s2c{walletItem_list =
			     if PFwalletItem_list /= undefined, NFwalletItem_list /= undefined -> 'erlang_++'(PFwalletItem_list, NFwalletItem_list, TrUserData);
				PFwalletItem_list == undefined -> NFwalletItem_list;
...
-compile({nowarn_unused_function,v_msg_res_list_bag_c2s/3}).
-dialyzer({nowarn_function,v_msg_res_list_bag_c2s/3}).
v_msg_res_list_bag_c2s(#res_list_bag_c2s{}, _Path, _) -> ok;
v_msg_res_list_bag_c2s(X, Path, _TrUserData) -> mk_type_error({expected_msg, res_list_bag_c2s}, X, Path).
...
v_msg_p_bag_item(#p_bag_item{id = F1, cfgId = F2, count = F3, max_count = F4, expired_time = F5, is_bind = F6}, Path, TrUserData) ->
    ...
    if F4 == undefined -> ok;
       true -> v_type_int64(F4, [max_count | Path], TrUserData)
    end,
    if F5 == undefined -> ok;
       true -> v_type_int64(F5, [expired_time | Path], TrUserData)
    end,
    if F6 == undefined -> ok;
...
v_msg_res_list_wallet_c2s(#res_list_wallet_c2s{}, _Path, _) -> ok;
v_msg_res_list_wallet_c2s(X, Path, _TrUserData) -> mk_type_error({expected_msg, res_list_wallet_c2s}, X, Path).
...
get_all_source_basenames() -> ["res.proto"].
...
get_pkg_containment("res") -> undefined;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("res") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("res") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("res") -> [];
