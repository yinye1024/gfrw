...
%%
ets_init()->
  s2s_glb_role_worker_mgr:ets_init(),
  ?OK.

start_svr()->
  s2s_glb_role_worker_mgr:start_sup_link(),
...
new_role(GlbRolePojo)->
  s2s_glb_role_worker_mgr:new_role(GlbRolePojo),
  ?OK.
update_role(GlbRolePojo)->
  s2s_glb_role_worker_mgr:update_role(GlbRolePojo),
  ?OK.
set_online(RoleId,IsOnline)->
  s2s_glb_role_worker_mgr:set_online(RoleId,IsOnline),
  ?OK.
