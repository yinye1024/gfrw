...
init({GenId})->
  ...
  glb_role_worker_ticker_mgr:init(),
  glb_role_worker_ticker_mgr:add_loop(1,{3600,fun glb_role_plrudb_mgr:check_lru/0}),
  ?OK.

loop_tick()->
  glb_role_worker_ticker_mgr:tick(),
  ?OK.
