...
%%
start_sup_link()->
  gs_lc_tpl_adm_mgr:start_sup_link(),
  ?OK.
...
%%  Result = gs_lc_tpl_adm_mgr:call_fun(CursorPid,{WorkFun,Param}),
%%  Result.
%%priv_cast_fun(CursorPid,{WorkFun,Param})->
%%  gs_lc_tpl_adm_mgr:cast_fun(CursorPid,{WorkFun,Param}),
%%  ?OK.
