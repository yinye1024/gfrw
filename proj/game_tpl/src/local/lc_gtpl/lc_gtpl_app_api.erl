...
%%
ets_init()->
  s2s_lc_gtpl_worker_mgr:ets_init(),
  ?OK.

start_svr()->
  s2s_lc_gtpl_worker_mgr:start_sup_link(),
  s2s_lc_gtpl_adm_mgr:start_sup_link(),
  ?OK.
...
new_gtpl(GlbTplPojo)->
  s2s_lc_gtpl_worker_mgr:new_gtpl(GlbTplPojo),
  ?OK.
update_gtpl(GlbTplPojo)->
  s2s_lc_gtpl_worker_mgr:update_gtpl(GlbTplPojo),
  ?OK.
set_online(TplId,IsOnline)->
  s2s_lc_gtpl_worker_mgr:set_online(TplId,IsOnline),
  ?OK.
